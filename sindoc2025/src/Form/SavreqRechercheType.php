    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('requeteRechercher', TextType::class, [
                ...
                'required' => true,
                'constraints' => [
                    new NotBlank(message: 'Veuillez specifier une requête de recherche'),
                    new Callback(
                        callback: function ($value, ExecutionContextInterface $context) {
                            ...
                            preg_match_all(
                                '/\b(?!ET\b|OU\b|NOT\b)[A-Za-zÀ-ÖØ-öø-ÿ0-9_-]+(?:\s+[A-Za-zÀ-ÖØ-öø-ÿ0-9_-]+)?\b/u',
                                $value,
                                $matches
                            );
                            $operands = array_map('strtolower', $matches[0]); // case-insensitive
