...
/* fiche/liste_fiches_sav_req.html.twig */
class __TwigTemplate_b6d10c6374be5e42ea1b267ca008115d extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "fiche/liste_fiches_sav_req.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "fiche/liste_fiches_sav_req.html.twig"));
...
";
        ...
        yield "
                <div class=\"card-body\">
                    ";
        // line 25
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["fiches"]) || array_key_exists("fiches", $context) ? $context["fiches"] : (function () { throw new RuntimeError('Variable "fiches" does not exist.', 25, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 26
            yield "                        <table class=\"table table-bordered\" id=\"fichesTable\">
                            <thead>
            ...
            // line 46
            yield "                        <h3>Aucune fiche trouvée.</h3>
                    ";
        }
        // line 48
        yield "                </div>
    ...
    ";
        // line 55
        yield from $this->load("fiche/fiche_modal.html.twig", 55)->unwrap()->yield($context);
        // line 56
        yield "    <script>
...
<script>
    const reqId = ";
        // line 70
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["reqId"]) || array_key_exists("reqId", $context) ? $context["reqId"] : (function () { throw new RuntimeError('Variable "reqId" does not exist.', 70, $this->source); })()), "html", null, true);
        yield ";
</script>
<script>
   \$(document).ready(function () {
        ...
        const fiches = ";
        // line 75
        yield (isset($context["fiches"]) || array_key_exists("fiches", $context) ? $context["fiches"] : (function () { throw new RuntimeError('Variable "fiches" does not exist.', 75, $this->source); })());
        yield ";
    ...
    render: function (data, type, row, meta) {
        ...
        let actions = `
    <a href=\"\${baseUrlAfficher}/\${data.Id}?index=\${rowIndex}&total=\${totalRows}&reqId=\${reqId}\"
...
";
    ...
    {
        return "fiche/liste_fiches_sav_req.html.twig";
    }
    ...
    {
        return array (  267 => 115,  263 => 114,  259 => 113,  255 => 112,  246 => 105,  242 => 103,  240 => 102,  210 => 75,  202 => 70,  196 => 67,  183 => 56,  181 => 55,  172 => 48,  168 => 46,  158 => 38,  154 => 36,  152 => 35,  141 => 26,  139 => 25,  135 => 23,  129 => 9,  126 => 8,  113 => 7,  101 => 5,  88 => 4,  65 => 3,  42 => 1,);
    }
...
{# 
    <form method=\"GET\" action=\"{{ path(\x27fiche_list\x27) }}\">
        ...
        <button type=\"submit\">Filtrer</button>
                ...
                <div class=\"card-body\">
                    {% if fiches is not empty %}
                        <table class=\"table table-bordered\" id=\"fichesTable\">
                            <thead>
                            <tr style=\"background-color: rgba(0, 0, 0, 0.4); \">
                                <th>#</th>  
                                <th scope=\"col\">Id</th>
...
{% endblock %}", "fiche/liste_fiches_sav_req.html.twig", "D:\\nvillard\\Mes documents\\sindoc2025\\sindoc2025\\templates\\fiche\\liste_fiches_sav_req.html.twig");
    }
}
