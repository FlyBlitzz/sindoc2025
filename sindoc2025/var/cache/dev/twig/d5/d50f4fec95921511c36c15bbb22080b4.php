...
/* livre/auth.html.twig */
class __TwigTemplate_87f96b44675c7a220b3af27438c92c2a extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "livre/auth.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "livre/auth.html.twig"));
...
<div class=\"container mb-5 pb-5\">
    ...
    <h3>Vous êtes sur le livre:  <i>";
        // line 14
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["livre"]) || array_key_exists("livre", $context) ? $context["livre"] : (function () { throw new RuntimeError('Variable "livre" does not exist.', 14, $this->source); })()), "nom", [], "any", false, false, false, 14), "html", null, true);
        yield "</i></h3>
    <p>Veuillez sélectionner un ou plusieurs utilisateurs</p>
    <form action=\"";
        // line 16
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_livre_app_livre_auth_save", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["livre"]) || array_key_exists("livre", $context) ? $context["livre"] : (function () { throw new RuntimeError('Variable "livre" does not exist.', 16, $this->source); })()), "idlivre", [], "any", false, false, false, 16)]), "html", null, true);
    ...
    <td>
        ";
            ...
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["auths"]) || array_key_exists("auths", $context) ? $context["auths"] : (function () { throw new RuntimeError('Variable "auths" does not exist.', 42, $this->source); })()), CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 42), [], "array", false, false, false, 42)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 43
                yield "            <a href=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_livre_app_livre_auth_remove", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["livre"]) || array_key_exists("livre", $context) ? $context["livre"] : (function () { throw new RuntimeError('Variable "livre" does not exist.', 43, $this->source); })()), "idlivre", [], "any", false, false, false, 43), "userId" => CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 43)]), "html", null, true);
                yield "\" 
...
";
    ...
    {
        return array (  192 => 53,  183 => 49,  173 => 43,  171 => 42,  167 => 40,  163 => 38,  159 => 36,  157 => 35,  152 => 33,  148 => 32,  139 => 31,  135 => 30,  118 => 16,  113 => 14,  103 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<div class=\"container mb-5 pb-5\">
    <h1>Donner des autorisations</h1>
    <h3>Vous êtes sur le livre:  <i>{{ livre.nom }}</i></h3>
    <p>Veuillez sélectionner un ou plusieurs utilisateurs</p>
    <form action=\"{{ path(\x27app_livre_app_livre_auth_save\x27, {id: livre.idlivre}) }}\" method=\"post\" id=\"authForm\">
        <div class=\"d-flex justify-content-end mb-3\">
            <button type=\"submit\" class=\"btn btn-primary\">Donner Autorisations</button>
        </div>
        <table id=\"userTable\" class=\"table text-center\">
    ...
    <td>
        {% if auths[user.id] %}
            <a href=\"{{ path(\x27app_livre_app_livre_auth_remove\x27, {id: livre.idlivre, userId: user.id}) }}\" 
               class=\"btn btn-danger\" 
               onclick=\"return confirm(\x27Etes-vous sûr de vouloir supprimer cette autorisation?\x27);\">
               Supprimer Autorisation
            </a>
...
{% endblock %}", "livre/auth.html.twig", "D:\\nvillard\\Mes documents\\sindoc2025\\sindoc2025\\templates\\livre\\auth.html.twig");
    }
}
