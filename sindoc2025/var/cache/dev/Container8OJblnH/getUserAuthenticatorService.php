...
class getUserAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \App\Security\UserAuthenticator($a, ($container->services['router'] ?? self::getRouterService($container)), $b);

        if (isset($container->privates['App\\Security\\UserAuthenticator'])) {
            return $container->privates['App\\Security\\UserAuthenticator'];
        }

        return $container->privates['App\\Security\\UserAuthenticator'] = $instance;
    }
}
