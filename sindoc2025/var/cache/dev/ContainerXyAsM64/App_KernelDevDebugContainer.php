...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Ckeditor5TestController' => 'getCkeditor5TestControllerService',
            'App\\Controller\\DeleteMotController' => 'getDeleteMotControllerService',
            ...
            'App\\Controller\\MotCleController' => 'getMotCleControllerService',
            ...
            'App\\Controller\\SavRequeteController' => 'getSavRequeteControllerService',
            'App\\Controller\\SecurityController' => 'getSecurityControllerService',
            'App\\Controller\\StatutController' => 'getStatutControllerService',
            'App\\Controller\\TestCkeditorController' => 'getTestCkeditorControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'dependency-injection'.\DIRECTORY_SEPARATOR.'Kernel'.\DIRECTORY_SEPARATOR.'KernelInterface.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'dependency-injection'.\DIRECTORY_SEPARATOR.'Kernel'.\DIRECTORY_SEPARATOR.'AbstractKernel.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'dependency-injection'.\DIRECTORY_SEPARATOR.'Kernel'.\DIRECTORY_SEPARATOR.'KernelTrait.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventSubscriber'.\DIRECTORY_SEPARATOR.'GlobalVariablesSubscriber.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'security-csrf'.\DIRECTORY_SEPARATOR.'SameOriginCsrfListener.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'dependency-injection'.\DIRECTORY_SEPARATOR.'Kernel'.\DIRECTORY_SEPARATOR.'BundleInterface.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'config'.\DIRECTORY_SEPARATOR.'Definition'.\DIRECTORY_SEPARATOR.'ConfigurableInterface.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'dependency-injection'.\DIRECTORY_SEPARATOR.'Extension'.\DIRECTORY_SEPARATOR.'ConfigurableExtensionInterface.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'dependency-injection'.\DIRECTORY_SEPARATOR.'Kernel'.\DIRECTORY_SEPARATOR.'AbstractBundle.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('utQwJJyUVb', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Kj7eFyXj3b', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gqSDsTToGJ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.controller', [#[\Closure(name: 'App\\EventSubscriber\\GlobalVariablesSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\GlobalVariablesSubscriber'] ?? self::getGlobalVariablesSubscriberService($container)), 'onKernelController'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\UsersController', 'App\\Controller\\Ckeditor5TestController', 'App\\Controller\\DeleteMotController', 'App\\Controller\\ErrorController', 'App\\Controller\\FicheController', 'App\\Controller\\HistoriqueController', 'App\\Controller\\HomeController', 'App\\Controller\\IndexController', 'App\\Controller\\LivreController', 'App\\Controller\\MainController', 'App\\Controller\\MotCleController', 'App\\Controller\\ProfileUserController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SavRequeteController', 'App\\Controller\\SecurityController', 'App\\Controller\\StatutController', 'App\\Controller\\TestCkeditorController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private 'App\EventSubscriber\GlobalVariablesSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\GlobalVariablesSubscriber
     */
    protected static function getGlobalVariablesSubscriberService($container)
    {
        $a = ($container->privates['twig'] ?? self::getTwigService($container));

        if (isset($container->privates['App\\EventSubscriber\\GlobalVariablesSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\GlobalVariablesSubscriber'];
        }

        $instance = new \App\EventSubscriber\GlobalVariablesSubscriber(($container->privates['App\\Repository\\LivreRepository'] ?? self::getLivreRepositoryService($container)), $a, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));

        if (isset($container->privates['App\\EventSubscriber\\GlobalVariablesSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\GlobalVariablesSubscriber'];
        }

        return $container->privates['App\\EventSubscriber\\GlobalVariablesSubscriber'] = $instance;
    }
     ...
     */
    protected static function getLivreRepositoryService($container)
    {
    ...
    {
        return $container->privates['cache.controller_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8yxE0woT8H', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('sMbEURpTaY', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tUmky+3pdw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iI+4PLb8zh', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mqJftvvspg', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tnPbXcLJHW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('u5f7Ftim7y', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('33bEDERZW1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    {
        return $container->privates['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FSFgAjw1q-', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Service\\SearchService' => ['privates', 'App\\Service\\SearchService', 'getSearchServiceService', true],
            'App\\Service\\WordService' => ['privates', 'App\\Service\\WordService', 'getWordServiceService', true],
            'App\\Repository\\FicheMotCleRepository' => ['privates', 'App\\Repository\\FicheMotCleRepository', 'getFicheMotCleRepositoryService', true],
            ...
            'App\\Repository\\IndexAuthRepository' => ['privates', 'App\\Repository\\IndexAuthRepository', 'getIndexAuthRepositoryService', true],
            'App\\Repository\\IndexRepository' => ['privates', 'App\\Repository\\IndexRepository', 'getIndexRepositoryService', true],
            'App\\Repository\\LivreAuthRepository' => ['privates', 'App\\Repository\\LivreAuthRepository', 'getLivreAuthRepositoryService', true],
            'App\\Repository\\LivreRepository' => ['privates', 'App\\Repository\\LivreRepository', 'getLivreRepositoryService', false],
            'App\\Repository\\MotCleRepository' => ['privates', 'App\\Repository\\MotCleRepository', 'getMotCleRepositoryService', true],
            'App\\Repository\\SavRequeteRepository' => ['privates', 'App\\Repository\\SavRequeteRepository', 'getSavRequeteRepositoryService', true],
            ...
            'App\\Repository\\FicheMotCleRepository' => '?',
            'App\\Repository\\FicheRepository' => '?',
            'App\\Repository\\HistoriqueRepository' => '?',
            'App\\Repository\\IndexAuthRepository' => '?',
            'App\\Repository\\IndexRepository' => '?',
            'App\\Repository\\LivreAuthRepository' => '?',
            'App\\Repository\\LivreRepository' => '?',
            'App\\Repository\\MotCleRepository' => '?',
            'App\\Repository\\SavRequeteRepository' => '?',
