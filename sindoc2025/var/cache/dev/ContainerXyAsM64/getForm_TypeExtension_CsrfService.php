...
class getForm_TypeExtension_CsrfService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.type_extension.csrf'] = new \Symfony\Component\Form\Extension\Csrf\Type\FormTypeCsrfExtension(($container->privates['security.csrf.same_origin_token_manager'] ?? $container->load('getSecurity_Csrf_SameOriginTokenManagerService')), true, '_token', ($container->services['translator'] ?? self::getTranslatorService($container)), 'validators', ($container->privates['form.server_params'] ?? $container->load('getForm_ServerParamsService')), $container->parameters['form.type_extension.csrf.field_attr'], ['App\\Form\\FicheMotCleType' => 'submit', 'App\\Form\\FicheType' => 'submit', 'App\\Form\\FicheTypeEdit' => 'submit', 'App\\Form\\HistoriqueType' => 'submit', 'App\\Form\\IndexType' => 'submit', 'App\\Form\\LivreType' => 'submit', 'App\\Form\\MotCleType' => 'submit', 'App\\Form\\RechercheFicheType' => 'submit', 'App\\Form\\RegistrationFormType' => 'submit', 'App\\Form\\ResetPassword' => 'submit', 'App\\Form\\SavRequeteType' => 'submit', 'App\\Form\\SavreqEdit' => 'submit', 'App\\Form\\SavreqRechercheType' => 'submit', 'App\\Form\\SelectLivreType' => 'submit', 'App\\Form\\StatutType' => 'submit', 'App\\Form\\UserType' => 'submit', 'App\\Form\\UserTypeEdit' => 'submit']);
    }
}
